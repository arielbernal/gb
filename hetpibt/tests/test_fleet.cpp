...
{
  // setup: 4x4 base grid, one fleet with cell_size=2 (2x2 fleet grid)
  ...
  // fleet 1 cell (0,0) with cell_size=2 should map to base cells
  // (0,0), (1,0), (0,1), (1,1)
  auto cells = cc.to_base_cells(1, 0, 2);  // cell_index=0, fleet_width=2
  ASSERT_EQ(cells.size(), 4u);

  // fleet 0 cell (0,0) with cell_size=1 maps to just base cell (0,0)
  auto cells0 = cc.to_base_cells(0, 0, 4);
